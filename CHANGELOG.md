...
- Replaced the repo-local `markdownlint-cli2` pre-commit and preflight wiring with pinned `markdownlint-cli@0.49.1` usage so markdown validation now aligns with the shared `.github` governance baseline.
